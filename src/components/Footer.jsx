...
export function Footer() {
  return (
    <footer className="flex flex-wrap items-center justify-center gap-6 border-t border-bone/10 bg-ink px-6 py-6">
      <p className="mr-auto font-display text-sm font-bold uppercase tracking-[0.2em] text-bone/35">Vaše zdraví i do zobaczenia</p>
      <ul className="flex flex-wrap gap-6" aria-label="Profile społecznościowe">
